...
const useShoppingHeaderSelectBarStore = create<ShoppingHeaderSelectBarStore>((set) => ({
  selectButton: "최근",
...
const useShoppingDetailSelectBarStore = create<ShoppingDetailSelectBarStore>((set) => ({
  isSelect: "설명",
